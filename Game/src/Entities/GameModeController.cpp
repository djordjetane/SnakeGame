...
namespace Game
{
    bool GameModeMenu::Init(Engine::EntityManager* entityManager_, Engine::TextureManager* textureManager_)
    {
        ...
        background->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("game_mode_menu");//ovde dodaj nove
        ...
        selectionSquare->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("selection_border");
        ...
        highlightSquare1->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("white");
        ...
        highlightSquare2->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("white");
        ...
        highlightSquare3->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("white");
        ...
        highlightSquare4->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("white");
        ...
        highlightSquare5->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("white");
        ...
        button11->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("yes");
        ...
        button12->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("no");
        ...
        button21->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("bounce_off");
        ...
        button22->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("death");
        ...
        button31->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("easy");
        ...
        button32->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("hard");
        ...
        buttonStart->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("start");
        ...
        buttonBack->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("back_button");
        ...
        text_1->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("text_1");
        ...
        text_2->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("text_2");
        ...
        text_3->AddComponent<Engine::SpriteComponent>().m_Image = textureManager_->GetTexture("text_3");
